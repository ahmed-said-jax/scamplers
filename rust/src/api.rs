...
pub fn router() -> Router<AppState> {
    // In theory, we should be able to inspect the header and route the request based on the API version set in the header, but I don't know how to do that yet
    v0::router()
}
