...
use super::ApiUser;
use crate::{db, db::person::UserRow, schema::person};
...
impl ApiUser {
    pub async fn fetch_by_api_key(
        ...
        // This is slightly dumb because first we look up the user by API key, then we
        // look up their roles by their ID. We can do a little better
