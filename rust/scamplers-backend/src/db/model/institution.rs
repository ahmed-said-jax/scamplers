use scamplers_core::institution::{Institution, NewInstitution};
...
impl Write for NewInstitution {
    ...
    async fn write(self, db_conn: &mut diesel_async::AsyncPgConnection) -> crate::db::error::Result<Self::Returns> {
